module.exports = function(app){
    ...
    app.get('/category-schedules',jwtMiddleware,schedule.getschedulebycategorysort); //카테고리별일정조회
    ...
    //app.get('/schedules/months/achievements',jwtMiddleware,schedule.getdonemonthcount);//월별해낸일정수조회
    app.get('/schedules/picks',jwtMiddleware,schedule.getpickschedule);//즐겨찾기일정조회
    app.get('/schedules/recents',jwtMiddleware,schedule.getrecentschedule);//최근생성일정조회
   
    //app.get('/category-schedules',jwtMiddleware,schedule.getschedulebycategory);//카테고리별 정렬 일정 조회
    ...
    app.get('/schedules/counts',jwtMiddleware,schedule.gettotalschedule);//전체일정수,총해낸일정수조회
